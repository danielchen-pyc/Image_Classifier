...
from tensorflow.compat.v1 import global_variables, Session
...
#         frozen_graph = tf.convert_variables_to_constants(
...
frozen_graph = freeze_graph(path, "dense_2/Softmax")
#
# k.set_learning_phase(1)
#
# frozen_graph = freeze_graph(Session(), output_names=[model.output.op.name])
